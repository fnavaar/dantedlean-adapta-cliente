# CLAUDE.md — Projeto Dlean Montagem de Estruturas Metálicas LTDA · Adapta
...
- **Objetivo:** organizar o fluxo de materiais entre demanda, projeto, Engenharia e planejamento, buscando processamento no mesmo dia após criação do baseline.
- **Processo atacado:** lead time de produção — planejamento de materiais e início da fabricação.
- **Consultor responsável:** Adapta Labs — contato a confirmar.
